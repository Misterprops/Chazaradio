...
function Lista() {
  ...
  useEffect(() => {
    fetch("http://localhost:3001/audios").then((res) => res.json()).then((data) => setAudios(data));
  }, []);
